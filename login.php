        ...
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    ...
                    <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Hi-Kode</div>
                </div>
            </div>
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-12">
                    <form name="form" action="cek-login-user.php" method="post">
                        <!-- <div>
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Nama</div>
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Ex. Tirta">
                        </div> -->
                        <div class="mt-8">
                            ...
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" id="nim" name="nim" type="nim" placeholder="Ex. 2105551007">
                        </div>
                        <div class="mt-10">
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Don't have an account ? <a href="register.php" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Register</a>
                    </div>
                </div>
            </div>
        </div>
