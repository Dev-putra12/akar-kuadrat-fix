                ...
                <div class="mt-12">
                    <form action="aksi-register.php" method="post">
                        <div>
                            ...
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="nama" id="nama" name="nama" placeholder="Ex. Tirta">
                        </div>
                        <div class="mt-8">
                            ...
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="nim" id="nim" name="nim" placeholder="Ex. 2105551007">
                        </div>
                        <div class="mt-10">
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Already have account ? <a href="login.php" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
